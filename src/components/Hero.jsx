    ...
    <section id="home" className="min-h-[90vh] grid grid-cols-1 xl:grid-cols-8">
      ...
      <div className="md:col-span-5 flex items-center justify-center p-8 xl:p-16">
        <div className="flex flex-col gap-8">
          ...
          Ayudamos a encontrar soluciones intuitivas y de acuerdo a los objetivos de negocio de cada cliente proporcionando un servicio de alta calidad.
          </p>
        ...
        <div>
          ...
          <div className="relative bg-white shadow-xl rounded-lg p-4 flex flex-col justify-center gap-2 max-w-[250px] mx-auto -mt-12">
            ...
            <div className="flex items-center gap-2 text-lg text-gray-500">
              <RiStarFill className="text-primary" /> 5.0 (3.1k Testimonios)
            </div>
